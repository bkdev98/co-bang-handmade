...
const Card = ({image, images, title, type = 'category', tag, pricing, slug}) => {
  let href = '', as = '';
  if (type === 'product') {
    href = "/product/[slug]";
    as = `product/${slug}`;
              ...
              <div className="card-header">
                ...
                {type === 'product' && (
                  <div className="pricing">
                    Từ <span className="amount">{pricing?.amount?.toLocaleString()}</span> <span className="currency">{pricing?.currency}</span>
                  </div>
                )}
              </div>
            </a>
